            ...
            <div className="container my-5 py-5">
                <div className="row">
                    <div className="col-12">
                        ...
                        <h1 className="display-6 text-center mb-4">Our <b>Awesome</b> Services</h1><hr className='w-25 mx-auto'/>
                    </div>
                </div>
                        ...
                        <div class="card p-3">
                           <div class="card-body text-center">
                            <i className="fa fa-file-code fa-4x mb-4 text-primary"></i>
                               <h5 class="card-title mb-3 fs-4 fw-bold">Unique ans Clean</h5>
                               <p class="card-text lead">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
